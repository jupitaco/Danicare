      ...
      <section className={`${styles.dolas}  d-flex flex-column flex-lg-row`}>
        <section className={`${styles.dL} order-1 order-lg-0 py-5 `}>
          ...
          <p>
            ...
            esteemed Psychiatrist, brings a wealth of expertise to our practice,
            serving a diverse range of individuals seeking comprehensive mental
            health care. With a strong educational background, including a B.A.
            in Biological Sciences from Rutgers University and an M.D. from
            Rutgers University School of Medicine, Dr. Ajanaku is dedicated to
            ...
            our patients, serving a wide scope and coverage. Mental well-being
            is our top priority, and DaniCare is committed to creating a warm
            and supportive environment for psychiatric care.
            <br /> <br />
